  ...
  if (form) {
    ...
    const msgs = {
      es: {
        ...
        error: 'Ha ocurrido un error al enviar. Por favor intente nuevamente o escriba a contacto@humanalegal.cl',
      ...
      en: {
        ...
        error: 'There was an error sending your message. Please try again or email contacto@humanalegal.cl',
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        // -------------------------------------------------------------------
        // Formspree endpoint — reemplazar 'TU_FORM_ID' por el ID real
        // (obtenerlo en https://formspree.io/forms tras crear el formulario)
        // Ejemplo final: 'https://formspree.io/f/xzzvabcd'
        // -------------------------------------------------------------------
        ...
        setTimeout(() => {
          window.location.href = `mailto:contacto@humanalegal.cl?subject=${encodeURIComponent('Consulta desde el sitio web')}&body=${mailtoBody}`;
        }, 1800);
      }
    });
  }
